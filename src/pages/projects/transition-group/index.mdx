...
title: Transition-Group Webcomponent
description: Standards-based, framework-agnostic utility for animating DOM elements as they enter a page, change position, or are removed from a page, using CSS transitions.
---
import GithubLink from '../../../components/github-link/github-link.astro'
import roseImgUrl from './_demos/puzzle/rose.jpg?url'
import PuzzleDemo from './_demos/puzzle/index.jsx'
import ColorBoxDemo from './_demos/color-boxes/color-boxes.jsx'
import ToastDemo from './_demos/toast-demo/index.jsx'
import SlideDemo from './_demos/slide-demo/index.jsx'
...
<PuzzleDemo client:only imageUrl={roseImgUrl} />
...
Click the boxes below to get an idea of how that looks:

<ColorBoxDemo client:only />
...
<GithubLink repo="webcomponent-transition-group" text="Visit on GitHub"/>