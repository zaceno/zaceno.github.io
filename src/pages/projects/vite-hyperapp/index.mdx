...
description: Use Vite as bundler and dev server for your Hyperapp projects. Supports JSX/TSX, hot module reloading and server-side rendering.
---
...
and to make sure your editor's TS language server picks up the right types for JSX/TSX,
add this line in your `src/vite-env.d.ts`:
